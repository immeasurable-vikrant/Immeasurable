   ...
   render() {
     return(
        ...
        <Card>
            <CardImg top width="100%" src="https://mirrorherald.com/wp-content/uploads/2018/11/neymar.jpg"/>
              <CardImgOverlay>
                ...
                <CardText className="text-center">
                Overcoming Comfort zone and Lazziness 
                 </CardText>   
                </div>  
              </CardImgOverlay>
            </Card>
        ...
        <Card>
            <CardImg top width="100%" src="https://e1.365dm.com/17/10/768x432/skysports-kaka-ac-milan-brazil_4125796.jpg?20171011171120"/>
              <CardImgOverlay>
                ...
                <CardText className="text-center">
                Unwavering Focus and Conecntration
                 </CardText>   
                </div>  
              </CardImgOverlay>
            </Card>
      ...
      <div className="col-3 col-md-3 offset-1">
        ...
        <Card>
        <CardImg top width="100%" src="https://images.alphacoders.com/269/269481.jpg" alt="Card image cap" />
        <CardBody>
